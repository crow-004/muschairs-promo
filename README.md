# Musical Chairs — Official Promo & Strategy Hub

This repository hosts the official landing page for **Musical Chairs**, the premier on-chain skill game built on **Arbitrum**. 

## 🎮 About the Project
Musical Chairs is a fast-paced, Web3-powered competition where timing and discipline are everything. Unlike traditional crypto games, we eliminate luck-based mechanics in favor of pure skill. Inspired by the rush of real-life movement and built for the decentralized era.

* **Main Site:** [muschairs.com](https://muschairs.com)
